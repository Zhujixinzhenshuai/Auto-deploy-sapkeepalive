// 环境变量配置(必填)
let email = "turekiss520@gmail.com";      // SAP登录邮箱,直接填写或设置环境变量，变量名：EMAIL
let password = "zjx616098.";   // SAP登录密码,直接填写或设置环境变量，变量名：PASSWORD

// 离线重启通知 Telegram配置(可选)
let CHAT_ID = "6984959042";    // Telegram聊天CHAT_ID,直接填写或设置环境变量，变量名：CHAT_ID
let BOT_TOKEN = "7687192013:AAEcG8LS5zNQztIWKoW6NfxCyidDylRoKHA";  // Telegram机器人TOKEN,直接填写或设置环境变量，变量名：BOT_TOKEN

// 应用配置 URL和应用名称配置(必填)
const MONITORED_APPS = [ // 格式: {url: "应用URL", name: "应用名称"}
  {url: "https://free-sgyoebol.cfapps.ap21.hana.ondemand.com", name: "free-sgyoebol"},  
  ];
